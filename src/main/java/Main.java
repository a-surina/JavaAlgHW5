...
public class Main {
    public static void main(String[] args) {
        ...
        HashMap<String, String[]> mapBlodTies = new HashMap<>();

        mapBlodTies.put("Vera", new String[]{});  //Прабабушка с дедушкой, у них предков нет (неизвестны)
        mapBlodTies.put("Alexey", new String[]{});

        mapBlodTies.put("Svetlana", new String[]{"Alexey", "Vera"}); // Бабушка с мужем
        mapBlodTies.put("Stepan", new String[]{"Ruslan", "Olga"});
        mapBlodTies.put("Oleg", new String[]{"Stepan", "Svetlana"}); // Их сын

        mapBlodTies.put("Nikolay", new String[]{"Alexey", "Vera"}); // Дедушка с женой и сыном
        mapBlodTies.put("Julia", new String[]{"Valentin", "Inna"});
        mapBlodTies.put("Yuriy", new String[]{"Nikolay", "Julia"}); // Их сын
        mapBlodTies.put("Oksana", new String[]{"Nikolay", "Julia"}); //Их дочь с мужем и дочерью
        mapBlodTies.put("Dmitriy", new String[]{"Grigoriy", "Yana"});
        mapBlodTies.put("Katya", new String[]{"Dmitriy", "Oksana"}); //Внучка

        //Проверяем, является ли Катя прымым кровным потомком
        System.out.println("Katya is lineal descendant of Grigoriy: " + rec.isLinealDescendant("Katya", "Grigoriy", mapBlodTies));
        System.out.println("Katya is lineal descendant of Vera: " + rec.isLinealDescendant("Katya", "Vera", mapBlodTies));
        System.out.println("Katya is lineal descendant of Oleg: " + rec.isLinealDescendant("Katya", "Oleg", mapBlodTies));
        System.out.println("Katya is lineal descendant of Stepan: " + rec.isLinealDescendant("Katya", "Stepan", mapBlodTies));
        System.out.println("Katya is lineal descendant of Yuriy: " + rec.isLinealDescendant("Katya", "Yuriy", mapBlodTies) + "\n");
